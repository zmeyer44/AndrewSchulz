...
export const colors = {
  ...
  success: '#27AE60',
  shades: {
    brand: ['#e50000', '#bf0000', '#bf0000', '#bf0000', '#bf0000'],
  },
...
export const typography = {
  googleFont:
    'https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,300;0,400;0,500;1,400&family=Bebas+Neue&family=Open+Sans&family=Roboto:wght@100;300;400;500;700;900&display=swap',
